...
export default function LoginModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" onClick={onClose}>
      <div
        className="w-full max-w-sm rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--surface))] p-6 shadow-xl"
      ...
      >
        ...
        {mode === "login" && (
          <>
            ...
            <div className="my-5 flex items-center gap-3 text-xs text-[rgb(var(--text-muted))]">
